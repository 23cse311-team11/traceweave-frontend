...
export const FloatingElements = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      <motion.div 
        className="absolute top-[15%] left-[8%] w-2 h-2 bg-brand-orange rounded-full opacity-60"
      ...
      />
      <motion.div 
        className="absolute top-[45%] right-[12%] w-3 h-3 border border-brand-orange/40"
        variants={floatingVariants}
