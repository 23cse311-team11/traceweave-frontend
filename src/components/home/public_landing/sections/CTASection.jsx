...
export const CTASection = () => {
  return (
    <section className="py-32 relative overflow-hidden">
      ...
      <motion.div 
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-brand-orange/10 rounded-full blur-[150px]"
      ...
      <div className="max-w-[1200px] mx-auto px-8 relative z-10 text-center">
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link 
              href="/login"
              className="group relative px-7 py-3 bg-brand-orange text-black font-bold text-lg rounded overflow-hidden flex items-center gap-3"
            >
