            ...
            <div className="p-8 space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-text-secondary">
                        Join the distributed tracing platform
                    </p>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase"><span className="bg-bg-panel px-2 text-text-muted">Or register with email</span></div>
                </div>
                ...
                <form className="space-y-4">
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            <User className="absolute left-3 top-2.5 h-5 w-5 text-text-muted group-focus-within:text-brand-orange transition-colors" />
                            <input
                                type="text"
