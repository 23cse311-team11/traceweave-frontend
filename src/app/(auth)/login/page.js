    ...
    return (
        <div className="glass-strong rounded-3xl overflow-hidden shadow-[0_0_50px_-12px_rgba(157,90,229,0.3)] border border-white/10 relative grain-texture">
            ...
            <div className="p-10 pb-4 text-center">
                ...
                <h1 className="text-3xl font-black text-white tracking-tight mb-2 font-mono italic">WELCOME BACK</h1>
                <p className="text-sm text-text-secondary tracking-wide">
                    The next era of distributed tracing.
                </p>
            </div>

            <div className="p-10 pt-6 space-y-8">
                {/* Social Auth - Premiumized */}
                ...
                <div className="relative py-2">
                    ...
                    <div className="relative flex justify-center text-[10px] font-mono uppercase tracking-[0.2em]"><span className="bg-transparent px-4 text-text-muted">Or access via email</span></div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        <label className="text-[10px] font-bold text-text-muted uppercase tracking-[0.15em] ml-1">Identity</label>
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center ml-1">
                            <label className="text-[10px] font-bold text-text-muted uppercase tracking-[0.15em]">Security Key</label>
                            <a href="#" className="text-[10px] font-bold text-brand-primary hover:text-white transition-colors uppercase tracking-widest">Forgot Access?</a>
                        </div>
                        <div className="relative group">
            ...
            <div className="px-10 py-6 bg-white/5 border-t border-white/5 text-center">
                <p className="text-sm text-text-secondary">
                    Need an account?{' '}
                    <Link href="/register" className="text-brand-primary hover:text-white font-bold transition-colors underline-offset-4 hover:underline">
                        Create One Free
                    </Link>
                </p>
            </div>
